...
title: "Supplementary Material: Incorporating observed fire severity in refined emissions
  estimates for boreal and temperate forest fires in the carbon budget model CBM-CFS3 v1.2"
output: 
  pdf_document:
    keep_tex: yes
date: "`r Sys.Date()`"
...
# S1 - Mean pool size by Reconciliation Unit
...
# S2 - Annual variability in observed Buildup Index during wildfire spread, and impact on modelled ecozone-level forest floor emissions
