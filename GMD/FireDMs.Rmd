...
```{r Fig1-RU-ecozones-NOT-RUN, eval=FALSE, fig.cap="\\label{fig::Fig1-RU-ecozones-NOT-RUN}Reconciliation Units used in the CBM-CFS3 framework.  Numbers correspond to RU identifiers that are different combinations of ecozones and subnational administrative units (provinces and territories). Non-forest arctic ecozones are not included in this analysis and are not shown in this figure.", message=FALSE, warning=FALSE, include=FALSE, out.width="50%"}
...
Component <- c("Stemwood","Foliage","Branches","Coarse woody debris","Forest Floor (incl dead fallen branches and coarse roots)","Snags")
...
```{r show-biplot-FFFC-new-calcs, fig.cap="Leave one out cross-validation of the forest floor consumption model.  Where multiple measurements were conducted within a single fire, the entire fire was excluded from the training data used in the model training.", echo=FALSE}
...
```{r show-biplot-FFFC-new, echo=FALSE, fig.cap="Leave one out cross-validation of the forest floor consumption model.  Where multiple measurements were conducted within a single fire, the entire fire was excluded from the training data used in the model training.", out.width="75%"}
