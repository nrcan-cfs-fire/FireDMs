...
knitr::include_graphics("~/nrcan-cfs-fire/FireDMs/emissions2023.png")
```
...
# Appendix B: Modelling of soil organic layer consumption
...
```{r example-FFFC-vs-BUI-plot-nls, echo=FALSE, fig.cap="Example of the forest floor consumption model for a duff layer (AGSlow) of 60 Mg C ha-1 (12 kg m-2)", out.width="75%", message=FALSE, warning=FALSE}
...
knitr::include_graphics("~/nrcan-cfs-fire/FireDMs/FFFC_vs_BUI_plot.png")
```
...
```{r show-biplot-FFFC-new, fig.cap="Leave one out cross-validation of the forest floor consumption model.  Where multiple measurements were conducted within a single fire, the entire fire was excluded from the training data used in the model training.", out.width="75%", echo=FALSE, message=FALSE, warning=FALSE}

### was getting a strange error since the output map in pdf was too large for the latex compiler somehow.  Inserting the above ggplot image as png instead 

knitr::include_graphics("~/nrcan-cfs-fire/FireDMs/FFFC_biplot.png")
```
...
```{r r FFFC-plot-next, fig.cap="Isoline contours of equal organic soil layer consumption fraction as a function of BUI and the organic soil layer (Medium DOM) Carbon pool in Mg C/ha.  Field observations of burn from 547 field measurements across Canada from the Yukon-Alaska border to Manitoba.", echo=FALSE, message=FALSE, out.width="75%", warning=FALSE}

### was getting a strange error since the output map in pdf was too large for the latex compiler somehow.  Inserting the above ggplot image as png instead 

knitr::include_graphics("~/nrcan-cfs-fire/FireDMs/FFFC_expand_plot.png")
```
...
knitr::include_graphics("~/nrcan-cfs-fire/FireDMs/plot_1.png")

```

```{r FFFC-plot-next3, eval=FALSE,out.width="75%", message=FALSE, warning=FALSE, include=FALSE,fig.cap="Isoline contours of equal organic soil layer consumption in kg/m2 as a function of BUI and the organic soil layer fuel load in kg/m2.  Field observations of burn from 547 field measurements across Canada from the Yukon-Alaska border to Manitoba"}
 

knitr::include_graphics("~/nrcan-cfs-fire/FireDMs/plot_2.png")


```

```{r FFFC-plot-next4, echo=FALSE, message=FALSE,out.width="75%", warning=FALSE,fig.cap="Forest floor consumption as a function of BUI across varying levels of forest floor fuel load (FFFL), as shown by coloured dots."}
 ###maybe like FBP with FFFC vs BUI, then varying lines of FFFL:
knitr::include_graphics("~/nrcan-cfs-fire/FireDMs/plot_3.png")
...
```{r AnnualBUI-calcs, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r AnnualDC-Vis-BUI50,out.width="75%", fig.cap="Annual variability in area-weighted median BUI of active fire spread days by ecozone.", echo=FALSE, message=FALSE, warning=FALSE}
 ###maybe like FBP with FFFC vs BUI, then varying lines of FFFL:
...
```{r AnnualBUI-Vis-Consump-calcs, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r AnnualBUI-Vis-frac-calcs, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r AnnualBUI-Vis-Consump, fig.cap="Annual variability in forest floor median consumption values by ecozone.", out.width="75%", echo=FALSE, message=FALSE, warning=FALSE}
 ###maybe like FBP with FFFC vs BUI, then varying lines of FFFL:
...
```{r AnnualBUI-Vis-frac, fig.cap="Annual variability in forest floor proportional consumption by ecozone.",  out.width="75%", echo=FALSE, message=FALSE, warning=FALSE}
 ###maybe like FBP with FFFC vs BUI, then varying lines of FFFL:
...
```
\newpage
```{r Appendix-D-knitr-png-1, echo=FALSE, fig.cap=exifinfo$Description[q], out.width="50%"}
...
```
\newpage
```{r Appendix-D-knitr-png-2, echo=FALSE, fig.cap=exifinfo$Description[q],out.extra='angle=-90', out.width="50%"}

knitr::include_graphics(exifinfo$SourceFile[q]) 
q <- q+1
```
\newpage
```{r Appendix-D-knitr-png-3, echo=FALSE, fig.cap=exifinfo$Description[q], out.width="50%"}

knitr::include_graphics(exifinfo$SourceFile[q]) 
q <- q+1
```
\newpage
```{r Appendix-D-knitr-png-4, echo=FALSE, fig.cap=exifinfo$Description[q], out.width="50%"}

knitr::include_graphics(exifinfo$SourceFile[q]) 
q <- q+1
```
\newpage
```{r Appendix-D-knitr-png-5, echo=FALSE, fig.cap=exifinfo$Description[q], out.width="50%"}
