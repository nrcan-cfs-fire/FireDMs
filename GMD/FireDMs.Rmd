...
kbl(CarbonEFs_pivot_wider,format = "pandoc",caption="Emissions factors for flaming and smouldering used in this model.  Values are the molar fraction of carbon in the unburned biomass and the emitted species, e.g. 87 percent of C in biomass is converted to C as CO2 in flaming combustion.") %>% kable_minimal()  
```
