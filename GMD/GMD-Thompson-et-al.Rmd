...
### "prop_sol_combusted" is the relevant response variable here.  and is the equivalent to the FFFC fractional consumption metric used in the analysis of de Groot's data
...
ABoVE.FFFC.Frac.Consume.nlsLM.excl.BC <- nlsLM(
  formula = prop_sol_combusted_logit ~ c*(1-exp(a*drought_code))+(log(MedDOM.Mg.C.ha)*b), 
