...
kbl(NIR_AverageCPools_filterCanopy,caption="Carbon pool size (Mg/ha) for canopy fuels by Reporting Unit for 2023") %>%
    kable_styling(full_width = F, html_font = "Cambria") %>%
  kable_styling(latex_options = "scale_down")  %>%
  kable_styling(latex_options = "hold_position")

kbl(NIR_AverageCPools_filterSurface,caption="Carbon pool (Mg/ha) for sub-canopy fuels by Reporting Unit for 2023") %>%
    kable_styling(full_width = F, html_font = "Cambria") %>%
  kable_styling(latex_options = "scale_down")  %>%
  kable_styling(latex_options = "hold_position")
...
```{r example-FFFC-vs-DC-plot-nls,fig.cap="2", echo=FALSE, message=FALSE, warning=FALSE}
