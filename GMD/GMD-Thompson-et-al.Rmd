...
```{r ternary-severity-plots, echo=FALSE, fig.cap="2023, fig.height=7, fig.width=7, message=FALSE, warning=FALSE}
...
Firegrowth_groups_v1_01 <- read.csv("CFSDB_summary.csv")
