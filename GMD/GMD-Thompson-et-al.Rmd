...
```{r tab-globalVarsEmissions, echo=FALSE, message=FALSE, warning=FALSE, tab.cap="\\label{tab:Emissions-factors}Emissions factors for flaming and smouldering used in this model."}
kbl(CarbonEFs_pivot_wider) %>%
  kable_minimal()  #%>%
...
```{r non-GWP-total-C-plot, echo=FALSE, fig.height=9, fig.width=6, message=FALSE, warning=FALSE,fig.cap="\\label{fig:non-GWP-total-C-plot}"}
...
```{r ternary-severity-plots, fig.cap="2023 fires shown as a ternary plot of severity class fractional area by ecozone and fire area"}
