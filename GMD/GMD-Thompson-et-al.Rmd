...
```{r Emissions-2023-table, eval=FALSE, include=FALSE}
...
##works BUT, since I reassigned the NBAC Reporting Units to fit the existing Avg C pool data, you get funny table outputs like the QC fires are "Labrador", so for now should report by ecozone only until that's fixed
...
With the parameter constrained NLS fitting, the proportional consumption model for the forest floor has a leave-one-out (conducted at the fire-level, not plot) cross validated r2 of 0.54, and a Mean Percent Error of 45%
