...
Give quick summary here, show overview map of all the fires, and also an example of the GCBM biomass pools and also severity
...
```{r AnnualDC-Vis, echo=FALSE,message=FALSE, warning=FALSE, fig.width=10,fig.height=11}
