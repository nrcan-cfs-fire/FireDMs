...
### Hayden et al showed that x% of total carbon goes into total PM (assume 50%? carbon content), and x% of total PM goes into PM2.5, so the CFFEPS values in Option 1A, but minus the PM phase (which is accounted for below in their own fluxes)
global.vars <- list(0.0, 0.00, 0.00, 0.0, 0.00, 0.0)

### the mass fraction of non-methane organic gases from Hayden et al is 31.2 g/kg (0.0312), what is the %C of that 31.2 g?
