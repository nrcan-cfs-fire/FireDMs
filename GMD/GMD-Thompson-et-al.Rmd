...
-   current use of RU and average (or random draw) from table/list when used to determine C impacts of disturbance doesn't reflect the fact that fire's burn preferrentially in the boreal in older conifer stands [@bernier2016].

-   Similarly, we also know that average severity is lower but also more variables in forest ecosystems like xeric boreal pines, as compared to higher and less variable severity in poorly drained spruce forests
